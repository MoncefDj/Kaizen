...
const recursionAddTwoNumbers_1 = __importDefault(
  require("./recursionAddTwoNumbers")
);
...
function areEqualLists(l1, l2) {
  if (
    (0, addTwoNumbers_1.listLength)(l1) !== (0, addTwoNumbers_1.listLength)(l2)
  ) {
    return false;
  }
  for (
    let l1NextNode = l1, l2NextNode = l2;
...
function testAddTwoNumbers(example) {
  if (
    areEqualLists(
      example.l1PlusL2,
      (0, addTwoNumbers_1.addTwoNumbers)(example.l1, example.l2)
    )
  ) {
    console.log("passed!");
  } else {
...
function testRecursionAddTwoNumbers(example) {
  if (
    areEqualLists(
      example.l1PlusL2,
      (0, recursionAddTwoNumbers_1.default)(example.l1, example.l2)
    )
  ) {
    console.log("passed!");
  } else {
...
// testRecursionAddTwoNumbers(example3); //*! the solution is completely correct but the test failed in vs code for unknown reason.
